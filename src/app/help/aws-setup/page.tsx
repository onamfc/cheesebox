    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg p-6 shadow-lg">
              ...
              <a
                href="#quick-setup"
                className="block w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-colors text-center"
              >
                Use Quick Setup →
              </a>
            </div>
        ...
        <section id="quick-setup" className="mb-12 scroll-mt-8">
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg p-8 shadow-lg">
            ...
            <div className="text-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-lg shadow-xl transition-all transform hover:scale-105 text-lg"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
        ...
        <div className="relative my-12">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-600 font-medium">
              OR
            </span>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="ml-12 space-y-4">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
                ...
                <ol className="space-y-2 list-decimal list-inside text-sm text-yellow-900">
          ...
          <section className="bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="ml-12 space-y-4">
              ...
              <div className="bg-green-50 rounded-lg p-4 border border-green-200 mt-4">
                ...
                <ol className="space-y-3 list-decimal list-inside text-green-800">
          ...
          <section className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg shadow-sm p-8 border-2 border-green-200">
            ...
            <div className="mt-8 flex gap-4">
              <Link
                href="/settings"
                className="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-colors text-center"
              >
